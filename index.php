...
<body class="homepage-1 int_white_bg ">
  ...
  <div id="wrapper" class="int_main_wraapper">
    ...
    <?php $mos = 0;
    if ($mos == 1) { ?>
      <div id="rev_slider_26_1_wrapper " class="rev_slider_wrapper fullscreen-container home-rev-slider mb-0" data-alias="mask-showcase" data-source="gallery">

        <div id="rev_slider_26_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
          <ul>

            <!-- SLIDE 1 -->
            <li data-index="rs-73" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/slider/2.jpg" data-rotate="0" data-saveperformance="off" data-title="" data-param1="1" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
              <!-- MAIN IMAGE -->
              <img src="images/slider/2.jpg" data-bgcolor='#f8f8f8' style='' alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
              ...
              <div class="tp-caption rev-btn  tp-resizeme slider-block sx-bg-primary" id="slide-73-layer-2" data-x="['left','left','left','center']" data-hoffset="['60','60','30','0']" data-y="['middle','middle','middle','top']" data-voffset="['-220','-220','-220','50']" data-fontweight="['600','600','600','600']" data-fontsize="['120','120','80','80']" data-lineheight="['120','120','80','80']" data-height="none" data-whitespace="nowrap" data-type="button" data-responsive_offset="on" data-frames='[{"from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},
                                {"delay":"wait","speed":500,"to":"y:[-100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power1.easeIn"}]' data-textAlign="['left','left','left','center']" data-paddingtop="[20,20,20,20]" data-paddingright="[10,10,10,10]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[10,10,10,10]" style="z-index: 10; font-family: 'Poppins', sans-serif;">&nbsp;</div>
            ...
            <li data-index="rs-74" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/slider/p-2.jpg" data-rotate="0" data-saveperformance="off" data-title="" data-param1="1" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
              ...
              <!-- LAYER 6  Learn More-->
              <div class="tp-caption rev-btn  tp-resizeme" id="slide-74-layer-6" data-x="['left','left','left','center']" data-hoffset="['60','60','30','0']" data-y="['middle','middle','middle','top']" data-voffset="['180','180','180','410']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="button" data-responsive_offset="on" data-frames='[{"from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},
                                {"delay":"wait","speed":500,"to":"y:[-100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power1.easeIn"}]' data-textAlign="['left','left','left','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index:9; line-height:30px;"><a href="about" class="site-button-secondry btn-half"><span> Book your Free Consultation</span></a></div>
     ...
     <ul class="clearfix">
      <li><a href="<?php print $siteInstagram; ?>" class="sx-title-swip" data-hover="Instagram">Instagram</a></li>
      <li><a href="<?php print $siteTwitter; ?>" class="sx-title-swip" data-hover="Twitter">Twitter</a></li>
      <li><a href="<?php print $siteFacebook; ?>" class="sx-title-swip" data-hover="Facebook">Facebook</a></li>
     </ul>
    </div> -->
    ...
    <div id="map-container" class="fullwidth-home-map dark-overlay">
      <div class="video-container">
        <video poster="images/bg/video-poster2.png" loop autoplay muted>
          <source src="video/Just-birthday.mp4" type="video/mp4">
        </video>
      </div>
      <div id="hero-area" class="main-search-inner search-2 vid">
        <div class="container" data-aos="zoom-in">
          <div class="row">
            <div class="col-12">
              <div class="hero-inner home-3">
                <div class="welcome-text" style="margin-top: 200px;">
                  <h1 class="h1">
                    <!-- Elegant Luxury <br /> -->
                    <br class="d-md-none">
                    <span class="typed border-bottom"></span>
                  </h1>
                  <p class="mt-4"> Welcome to <?php print $siteName; ?> Transforming Spaces, Elevating Lifestyles.<br />
                    <a href="contact" class="site-button-secondry btn-half"><span> Book your Free Consultation</span></a>
                  </p>
                </div>
              </div>
            </div>
    ...
    <section class="recently portfolio bg-white-5" style="padding-top: 50px; display: none;">
      <div class="container-fluid recently-slider">
        <div class="section-title">
          <h3>Recently Works</h3>
        </div>
        <div class="portfolio right-slider">
          <div class="owl-carousel home5-right-slider">

            <?php $sql = query_sql("SELECT * FROM $gallery_tb ORDER BY id DESC LIMIT 20");
            $i = 1;
            if (mysqli_num_rows($sql) > 0) {
              while ($row = mysqli_fetch_assoc($sql)) {
            ?>
                <div class="inner-box">
                  <a href="portfolio" class="recent-16" data-aos="fade-up">
                    <div class="recent-img16 img-fluid img-center" style="background-image: url(<?php print 'photo/' . $row['image']; ?>);"></div>
                    <div class="recent-content"></div>
                    <div class="recent-details">
                      <div class="recent-title"><?php print $row['caption']; ?></div>
                    </div>
    ...
    <section class="info-help h18" style="display: none;">
      <div class="container">
    ...
    <section _ngcontent-bgi-c3="" class="featured-boxes-area" style="display: none;">
          ...
          <div _ngcontent-bgi-c3="" class="row m-0">
            <div _ngcontent-bgi-c3="" class="col-lg-3 col-sm-6 col-md-6 p-0" data-aos="fade-up">
              <div _ngcontent-bgi-c3="" class="single-featured-box">
                ...
                <p _ngcontent-bgi-c3="">We create personalized, stylish interiors that reflect your unique taste and enhance your home's functionality.</p><a _ngcontent-bgi-c3="" class="read-more-btn" href="portfolio">Learn More</a>
              </div>
            </div>
            <div _ngcontent-bgi-c3="" class="col-lg-3 col-sm-6 col-md-6 p-0" data-aos="fade-up">
              <div _ngcontent-bgi-c3="" class="single-featured-box">
                ...
                <p _ngcontent-bgi-c3="">Our proven track record and satisfied clients showcase our commitment to delivering high-quality, innovative designs.</p><a _ngcontent-bgi-c3="" class="read-more-btn" href="portfolio">Learn More</a>
              </div>
            </div>
            <div _ngcontent-bgi-c3="" class="col-lg-3 col-sm-6 col-md-6 p-0" data-aos="fade-up">
              <div _ngcontent-bgi-c3="" class="single-featured-box">
                ...
                <p _ngcontent-bgi-c3="">Flexible financing options tailored to your budget make achieving your dream home stress-free and affordable.</p><a _ngcontent-bgi-c3="" class="read-more-btn" href="portfolio">Learn More</a>
              </div>
            </div>
            <div _ngcontent-bgi-c3="" class="col-lg-3 col-sm-6 col-md-6 p-0" data-aos="fade-up">
              <div _ngcontent-bgi-c3="" class="single-featured-box">
                ...
                <p _ngcontent-bgi-c3="">Our dedicated support team is available around the clock to assist you with any questions or concerns.</p><a _ngcontent-bgi-c3="" class="read-more-btn" href="portfolio">Learn More</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="portfolio bg-white-5" style="padding-bottom: 10px; display: none;">
      <div class="container">
        <div class="section-title">
        ...
        <div class="filters-group">
          <ul>
            <li style="display: none;" class="active" data-filter="*"></li>
              ...
              <div class="item col-lg-4 col-md-6 people landscapes" data-aos="zoom-in">
                <div class="single-portfolio">
                  <div class="portfolio-img card">
                    <img src="<?php print 'photo/' . $row['big_image']; ?>" alt="" />
      ...
      <!-- <div class="box bg-3 mt-0">
        <a href="portfolio" class="button button--wayra button--border-thick button--text-upper button--size-s">View All</a>
      </div> -->
    </section>

    <section class="info-help h17" style="display: none;">
      <div class="container">
        <div class="row info-head">
          <div class="col-lg-6 col-md-8 col-xs-8" data-aos="fade-right">
            <div class="info-text">
              <h3>Living with Modern Interior Concepts</h3>
              <p class="pt-2">At <?php print $siteName; ?>, we believe that your space should reflect your personality and enhance your lifestyle. With a keen eye for detail and a passion for design, we create stunning interiors that inspire and delight. Explore our services and let us bring your vision to life. </p>
              <div class="inf-btn pro">
                <a href="services" class="btn btn-pro btn-secondary btn-lg">Get Started</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-6 mb-2">
          <div class="">
            <img src="img/Interior-Culture-by-Adiat-Oke-26.jpg" alt="" />

          </div>
          <a href="services" class="text-white" style="text-decoration: none;">
            <div class="text-overlay">
              <h2>Our Services</h2>
              <p class="pt-2 font-newer"> <em>At <?php print $siteName; ?>, we offer a comprehensive range of interior design services to meet your needs.</em></p>
            </div>
          </a>
        ...
        <div class="col-lg-6 mb-2">
          <div class="">
            <img src="img/Interior-Culture-by-Adiat-Oke-23.jpg" alt="" />

          </div>
          <a href="portfolio" class="text-white" style="text-decoration: none;">
            <div class="text-overlay">
              <h2>Our Portfolio</h2>
              <p class="pt-2 font-newer"> <em>Browse through our portfolio to see examples of our recent projects. Each image tells a story of transformation, showcasing our ability to blend style, comfort, and functionality.</em></p>
            </div>
          </a>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 who-1">
            <div>
              <h2 class="text-left mb-4" data-aos="fade-up">Frequently Asked Questions </span></h2>
            </div>
            <div class="pftext" style="font-family: " baskerville-display-pt", Georgia, Times, Times New Roman, serif;">
              <h3>1. What services does Interior Culture by Adiat Oke offer?</h3>
              <p data-aos="fade-up">
                Interior Culture offers a wide range of services including full-scale interior design, home décor consultations, space planning, decluttering and organization, and project management for both residential and commercial spaces. We tailor our services to meet your specific needs and preferences.
              </p>
              <br />
              <h3>2. How can I book a consultation with Adiat Oke?</h3>
              <p data-aos="fade-up">
                Booking a consultation is easy! Simply visit our website’s Contact Us page, fill out the inquiry form, or email us directly at <?php print $siteEmail; ?>. We’ll get back to you promptly to schedule a convenient time. The consultation can be virtual or physical, depending on the client’s preference.
              </p>
              <br />
              <h3>3. What should I expect during the initial consultation?</h3>
              <p data-aos="fade-up">
                During the initial consultation, Adiat will discuss your vision, lifestyle, and preferences. She will assess your space, understand your requirements, and provide insights on potential design solutions. This session is all about getting to know you and your style.
              </p>
              <br />
              <h3>4. How does the design process work at Interior Culture?</h3>
              <p data-aos="fade-up">
                Our design process is collaborative, and client focused. After the initial consultation, Adiat will create a customized design plan, including mood boards and layouts. We’ll review the plan together, make any necessary adjustments, and proceed to implementation once you’re completely satisfied.</p>
              <br />
              <h3>5. What is the typical timeline for a project?</h3>
              <p data-aos="fade-up">
                The timeline for each project varies based on its scope and complexity. A typical project can range from a few weeks for a room refresh to several months for a full home renovation. We’ll provide a detailed timeline during the planning stage.
              </p>
              <br />
              <h3>6. How does Interior Culture ensure projects stay within budget?</h3>
              <p data-aos="fade-up">
                We prioritize transparency and communication. During the planning phase, we’ll establish a clear budget and provide detailed cost estimates. Adiat will work closely with you to ensure that the design aligns with your financial expectations without compromising on quality.
              </p>
              <br />
              <h3>7. Can Interior Culture work with my existing furniture and décor?</h3>
              <p data-aos="fade-up">
                Absolutely! Adiat excels at integrating existing pieces into new designs. We’ll assess your current furniture and décor to determine how they can be incorporated or enhanced to fit the new design vision, ensuring a harmonious and refreshed space.
              </p>

              <br />
              <p data-aos="fade-up"><em>If you have any more questions, please feel free to reach out. We’re here to help make your dream interiors a reality!</em></p>
      ...
      <div class="container">
        ...
        <div class="owl-carousel style1">
          <div class="test-1" data-aos="zoom-in">
            ...
            <p>Working with Adiat was a wonderful experience. She understood our vision perfectly and turned our house into a home we love.</p>
          </div>
          <div class="test-1" data-aos="zoom-in">
            <h3>Jhon Morris</h3>
            ...
            <p>Interior Culture transformed our living room into a stylish and comfortable space. We couldn’t be happier with the result.</p>
          </div>
          <div class="test-1" data-aos="zoom-in">
            <h3>Mary Deshaw</h3>
            ...
            <p>Adiat's attention to detail and creative solutions exceeded our expectations. Highly recommend!</p>
          </div>
          <div class="test-1" data-aos="zoom-in">
            <h3>Gary Steven</h3>
            ...
            <p>Adiat made our kitchen renovation stress-free and enjoyable. Her expertise and professionalism were evident throughout the process.</p>
          </div>
          <div class="test-1" data-aos="zoom-in">
            <h3>Cristy Mayer</h3>
            ...
            <p>Interior Culture's team was professional, efficient, and incredibly talented. Our office space is now both functional and beautiful.</p>
          </div>
          <div class="test-1" data-aos="zoom-in">
            <h3>Ichiro Tasaka</h3>
            ...
            <p>Their home staging services were a game-changer. Our property sold quickly and for a great price.</p>
          </div>
        </div>
      </div>
    </section>
