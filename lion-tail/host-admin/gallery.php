...
if (isset($_POST['post'])) {
  ...
  if (!empty($pic_name)) {
    ...
    if (query_sql("INSERT INTO $gallery_tb VALUES(null ,'" . $caption . "','','" . $new_name . "','" . $date_created . "')")) {
...
if (isset($_GET['iddel']) && !empty($_GET['iddel'])) {
  $passportIn = $cal->selectFrmDB($gallery_tb, 'image', 'id', $_GET['iddel']);
  if (query_sql("DELETE FROM $gallery_tb WHERE `id`='" . $_GET['iddel'] . "' LIMIT 1")) {
    $bassic->unlinkFile($passportIn, '../../photo/');
    $msg = 'Delete process was successful!';
    header("location:gallery?done=" . $msg);
  } else {
  ...
  <section id="container" class="" style="margin-bottom:100px;">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Gallery</h3>
            <ol class="breadcrumb">
        ...
        <?php } else { ?>
          <div class="row">
            <div id="go" class=" col-lg-12">
              <div id="go" class="alert alert-warning" style="text-align: center; color:#000;">NOTE: You can add Gallery here. Thanks <i id="remove" class="fa fa-remove pull-right"></i></div>
            </div>
          </div>
        <?php } ?>
        <div class="row">
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <th><?php print $row['caption']; ?></th>
                          <th><img width="70px" src="<?php print '../../photo/' . $row['image']; ?>" alt=""></th>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <a href="gallery?iddel=<?php print $row['id']; ?>">
