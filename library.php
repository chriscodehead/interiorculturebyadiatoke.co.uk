...
$siteLink = 'https://interiorculturebyadiatoke.co.uk/accounts/register';
$siteRegister = 'https://interiorculturebyadiatoke.co.uk/accounts/register';
$siteLogin = 'https://interiorculturebyadiatoke.co.uk/accounts/login';
$site = 'https://interiorculturebyadiatoke.co.uk';

$domain = 'interiorculturebyadiatoke.co.uk';
$siteName = $row['site_name'];
$site_email = $row['site_email'];
$siteEmail = "support@interiorculturebyadiatoke.co.uk";
$siteEmail2 = "contact@interiorculturebyadiatoke.co.uk";
...
class Cal extends DBConnection
{
    ...
    protected $portfolio_tb  = 'portfolio_tb';
    ...
    public function login($email, $password, $page, $usernamefield, $passwordfield, $table)
    {
        ...
        if ($stmt->execute()) {
            ...
            if ($row['blocked_account'] == 1) {
                return 'Your Account is locked please <a style="color:#FFF;" href="mailto:support@interiorculturebyadiatoke.co.uk"><u>contact support: support@interiorculturebyadiatoke.co.uk</u></a>';
...
<body>
<h6><img src="https://www.interiorculturebyadiatoke.co.uk/img/logo.png" /></h6>
<div style="font-size: 14px;">
<p>
Hello, ' . $name . '
</p><p>
This email contains your 2 Factor Authentication code to complete your login at interiorculturebyadiatoke.co.uk.
</p>
Email: ' . $email . '<br />
...
Email: support@interiorculturebyadiatoke.co.uk<br />
</p>
 </div>
</body>
</html>';
        ...
        $header .= 'From: Dulcet Care <support@interiorculturebyadiatoke.co.uk>' . "\r\n";
            ...
            <table width="100%" border="0" cellspacing="0"
                ...
                <tr>
                    <td class="img m-center"
                        ...
                        <img src="https://interiorculturebyadiatoke.co.uk/img/logo.png"
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td class="img" width="55"
                        ...
                        <a href="#" target="_blank"><img
                                src="https://interiorculturebyadiatoke.co.uk/mail_images/ico_facebook.jpg"
                    ...
                    <td class="img" width="55"
                        style="font-size:0pt; line-height:0pt; text-align:left;">
                        <a href="#" target="_blank"><img
                                src="https://interiorculturebyadiatoke.co.uk/mail_images/ico_twitter.jpg"
                                width="38" height="38" border="0"
                                alt="" /></a>
                    </td>
                    <td class="img" width="55"
                        style="font-size:0pt; line-height:0pt; text-align:left;">
                        <a href="#" target="_blank"><img
                                src="https://interiorculturebyadiatoke.co.uk/mail_images/ico_instagram.jpg"
                                width="38" height="38" border="0"
                                alt="" /></a>
                    </td>
                    <td class="img" width="38"
                        style="font-size:0pt; line-height:0pt; text-align:left;">
                        <a href="#" target="_blank"><img
                                src="https://interiorculturebyadiatoke.co.uk/mail_images/ico_linkedin.jpg"
                                width="38" height="38" border="0"
                                alt="" /></a>
                    </td>
                </tr>
    ...
    <tr>
        <td class="text-footer1 pb10"
            ...
            Email:info@interiorculturebyadiatoke.co.uk, support@interiorculturebyadiatoke.co.uk
...
from this mailing list.
    ...
    ';
        $header = "MIME-Version: 1.0" . "\r\n";
        $header .= "Content-type:text/html;charset=UTF-8" . "\r\n";
        $header .= 'From: NETZONE META TRADING <support@interiorculturebyadiatoke.co.uk>' . "\r\n";
        $retval = @mail($to, $subject, $message, $header);
